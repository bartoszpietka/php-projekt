...
<body>
    <div id="header">
        ...
        if($_SESSION["czyzalogowano"] == false){
            echo "<button style='font-size: 20px; background-color: #10101000; border: 2px solid white; width: 130px; color: #ffffff;' onclick='zaloguj()'>Zaloguj się</button>";
            ...
            <button style='font-size: 20px; background-color: #10101000; border: 2px solid white; width: 130px; color: #ffffff;' onclick='wyloguj()'>Wyloguj się</button>";
        }
        ?>
    </div>
